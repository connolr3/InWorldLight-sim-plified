...
/// </summary>
public class ProximityExperiment : Experiment {
    ...
    public ProximityExperiment(ExperimentRunner runner, RunnableDesign runnableDesign) : base(runner, runnableDesign) {
